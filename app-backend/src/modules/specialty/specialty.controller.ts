...
export class SpecialtyController {
  ...
  static async list_soft_delete(req: Request, res: Response) {
    const specialties = await SpecialtyService.list_soft_delete();
  ...
  static async restore(req: Request, res: Response) {
    ...
    const specialty = await SpecialtyService.restore(id);
